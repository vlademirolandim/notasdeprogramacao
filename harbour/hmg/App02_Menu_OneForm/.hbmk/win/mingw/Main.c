 ...
 * Generated C source from "C:\CursoHMG\CookBook\App02_Menu_OneForm\Main.Prg"
 */
...
{ "FORM01", {HB_FS_PUBLIC}, {HB_FUNCNAME( FORM01 )}, NULL },
...
HB_INIT_SYMBOLS_EX_END( hb_vm_SymbolInit_MAIN, "C:\\CursoHMG\\CookBook\\App02_Menu_OneForm\\Main.Prg", 0x0, 0x0003 )
...
HB_FUNC( MAIN )
{
	static const HB_BYTE pcode[] =
	{
		...
		227,1,93,243,0,93,38,2,93,94,1,9,9,9,
		...
		20,2,36,8,0,176,5,0,106,5,70,111,114,109,
		0,90,8,176,6,0,12,0,6,100,100,9,9,100,
		20,7,36,9,0,176,7,0,20,0,36,10,0,176,
		8,0,20,0,36,12,0,176,9,0,20,0,36,6,
		0,176,10,0,106,5,77,97,105,110,0,106,7,67,
		101,110,116,101,114,0,20,2,36,7,0,176,10,0,
