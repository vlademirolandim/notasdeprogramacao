...
PROCEDURE Main()
   ...
   ? "drop table teste" , tmp := FBExecute( db, "drop table teste", nDialect ), tmp, FBError( tmp )
   ? "Create table teste" , tmp := FBExecute( db, "create table teste (code smallint)", nDialect ), FBError( tmp )
   ? "Create table teste" , tmp := FBExecute( db, "create table teste (code smallint)", nDialect ), FBError( tmp )
